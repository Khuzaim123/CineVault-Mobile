...
import { FilmIcon, StarIcon, SignalIcon } from '../../components/icons';
import { Colors, Fonts, Spacing, Radius } from '../../constants/theme';

const CATEGORIES = [
  { label: 'Popular', fetchFn: () => tmdb.getPopularMovies() },
  { label: 'Top Rated', fetchFn: () => tmdb.getTopRatedMovies() },
  { label: 'Now Playing', fetchFn: () => tmdb.getNowPlaying() },
  { label: 'Upcoming', fetchFn: () => tmdb.getUpcomingMovies() },
];
